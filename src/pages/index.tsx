...
function HomePage() {
  return (
    <>
      <Head>
        <title>BookBite</title>

        <meta
          name="description"
          content="Empower Your Culinary Journey with BookBite: The Ultimate SaaS Application for Streamlining Restaurant Management and Elevating Guest Experiences"
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              ...
              Management and Elevating Guest Experiences
            </Text>
            <Text>Owner</Text>
